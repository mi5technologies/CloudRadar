...
export const RECOMMENDATIONS = {
  ...
  'lambda.timeout': {
    title: 'Lambda Function Has Excessive Timeout',
    what: 'The Lambda function timeout is set to the maximum (15 minutes) without justification.',
    why: 'Excessively long timeouts increase cost from runaway invocations and mask performance issues.',
    fix: [
      'Set the timeout to the 95th percentile of expected execution time + 30% buffer.',
      'Use CloudWatch Metrics to analyze actual p99 duration.',
      'Add dead-letter queues (DLQ) for failed invocations.',
    ],
    docs: 'https://docs.aws.amazon.com/lambda/latest/dg/configuration-timeout.html',
    severity: 'low',
  },
 ...
 * Tries exact rule_id match first, then resource_type prefix match.
 */
export function getRecommendation(finding) {
  ...
  return {
    ...
    fix: [
      ...
      'Consult the AWS Security Best Practices documentation for this service.',
      'Consider enabling AWS Config rules to automatically detect and alert on this issue.',
    ],
